...
global.owner = process.env.OWNER_NUMBER  || '94722770762' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=qBM2hSJS#yys1HnpaNh_g5zAODwwu5MTIUP9kWrviLXqG8OffwUI' ,
...
POSTGRESQL_URL: process.env.POSTGRESQL_URL === undefined ? 'postgres://koyeb-adm:c0hSZ6MqYORx@ep-divine-mountain-a2hcrsoh.eu-central-1.pg.koyeb.app/koyebdb' : process.env.POSTGRESQL_URL,
