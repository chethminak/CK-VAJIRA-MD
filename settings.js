...
global.owner = process.env.OWNER_NUMBER  || '94779510013' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=LQtARRha#-9uUy21G7YEDWAUe-T8LkvzXrbCTicMfBOhSNF-EAlU' ,
